 ...
 *
 * Called nightly by an external automation (n8n, cron, etc.) to update
 * the AI-generated claim_summary for a specific claim.
 *
...
export async function POST(req: NextRequest) {
  ...
  // 3. Use service role key — bypasses RLS (trusted backend call)
  ...
  return NextResponse.json({ ok: true, claim_id: data.claim_id })
}
