...
const schema = z.object({
  ...
  temperature_log_present: z.boolean().default(false),
...
export function DamageReportForm({ claim, role }: DamageReportFormProps) {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      affected_units: claim.affected_units ?? undefined,
      total_units: claim.total_units ?? undefined,
      estimated_loss_usd: claim.estimated_loss_usd ?? undefined,
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <ReadField
              ...
              value={claim.estimated_loss_usd != null ? `$${claim.estimated_loss_usd.toLocaleString()}` : null}
            />
            <ReadField label="Damage Location" value={claim.damage_location} />
            <ReadField label="Inspector" value={claim.inspector_name} />
            <ReadField
              label="Inspection Date"
              value={claim.inspection_date ? new Date(claim.inspection_date).toLocaleDateString() : null}
            />
            <ReadField
